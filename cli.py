...
def get_args():
    ...
    parser.add_argument('-trun', '--truncate', help='Truncate the sequence length to', type=int, required=False, default=512)
    ...
    parser.add_argument('-fm', '--feat-model', help='Which feature to use in social graph', type=str, required=False, default='soft')
    parser.add_argument('-fi', '--feat-init', help='Which feature initialization to use in social graph', type=str, required=False,
                        default='non_off')
    # Data path
